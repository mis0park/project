...
- High specific heat → resistance to temperature change → stable internal/external environments
- High heat of vaporization → evaporative cooling → temperature regulation

**EK 1.1.A.2 Emergent properties of hydrogen bonding**
- Hydrogen bonding produces:
...
- Living systems regulate these reactions using enzymes (mechanism in Unit 3).

---

## Topic 1.4 — Properties of Biological Macromolecules

### Essential Knowledge 1.4.A
- Structure determines function for biological macromolecules.
...
| Protein       | Amino acids     | Catalysis; structure; transport      |
| Nucleic acid  | Nucleotides     | Information storage and transfer     |
```
...
### Structural variation (CED-tested)
- **Alpha (α) glycosidic linkages**
  - Found in starch and glycogen
  - Allow enzymes to easily hydrolyze bonds → energy storage
...
| Cellulose  | β            | Structural support          |
```

**CED reasoning pattern**
- Branching → more ends → faster access to glucose
...
- **Saturated fatty acids**
  - No double bonds
  - Straight chains → tighter packing → solid at room temperature
...
- Spontaneously form bilayers in aqueous environments → membrane structure
...
**Denaturation**
- Loss of protein structure due to environmental change
- Disrupts secondary, tertiary, and quaternary structure
- Reduces or eliminates function
...
- Phosphodiester bonds form between 3′ OH and 5′ phosphate.
...
**CED reasoning**
- Complementary base pairing → accurate information storage and transfer

---

# Unit 1 Recall Sheet (CED-aligned)

- Polarity → hydrogen bonding → emergent properties
- α vs β linkages → carbohydrate function
- Fatty acid saturation → membrane fluidity
- R-group interactions → protein folding
- Phosphodiester bonds → nucleic acid directionality
