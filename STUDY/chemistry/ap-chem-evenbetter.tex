...
% =========================================================
% TOC FORMAT (cleaner indentation)
% =========================================================
...
\newcommand{\startunitpreview}[2]{% unitno, unittitle
  ...
  \phantomsection
  \addcontentsline{toc}{section}{\protect\numberline{U#1}Unit #1 Preview: #2}%
}
...
% Unit builder: preview + auto topic pages
\newcommand{\makeunit}[3]{% unitno, unittitle, topiclist
  ...
  \begin{ex}{How to use}
    ...
    Fill each Topic page later — the links already exist.
  \end{ex}
  ...
  \foreach \tn/\tt in {#3}{
    \edef\LocalTopicNum{\tn}\edef\LocalTopicTitle{\tt}%
    \expandafter\topicstub\expandafter{Unit #1: #2}{\LocalTopicNum}{\LocalTopicTitle}{#1}%
  }
}
